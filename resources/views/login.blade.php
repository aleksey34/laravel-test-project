...
{{--        </div>--}}
        <div class="container my-4">
            <h2 class="text-center">Войдите в свой профайл</h2>
            <form method="POST" class="bordered col-3 mx-auto" action="{{route('user.loginForm')}}">
                @csrf
                <div class="mb-3">
        ...
        <nav style="width: 100% ; text-align: center;">
            <ul class="list-unstyled" style="display: inline-flex; list-style: none;padding: 1rem;border: 1px solid black;">
                ...
                <li style="padding: 7px 5px;"><a href="{{route('user.registration')}}">Registration</a></li>
            </ul>
        </nav>
